...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <link href="/css/mainAR.css" rel="stylesheet">
...
<p class="sign">@lang('message.signin') <br/> 
   <span class="account">@lang('message.account')</span>
</p>
<p class="signdesc">@lang('message.desc')
<br> 
<a class="btn contact" href="{{ url('contact') }}" role="button">@lang('message.contact')</a>
</p>
<img id="Saly" src="/img/Saly.png" alt="WiiN Logo"></img>
</div>

<p id="logas">@lang('message.logas')</p>
