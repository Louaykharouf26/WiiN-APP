@extends('ar.layouts.layoutprovider')
@section('content1')
<div class="postbx">
...
<p class="name">@lang('message.signin') </p>
...
<img id="logoE1" src="/img/hugo.png" alt="WiiN Logo"></img>
...
<img id="logoE1" src="/img/john1.png" alt="WiiN Logo"></img>
...
<img id="logoE1" src="/img/mauren1.png" alt="WiiN Logo"></img>
