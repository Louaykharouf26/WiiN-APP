...
<body >
<div class="box">
<select onchange="changeLanguage(this.value)" id="langue" class="btn">
...
<p class="sign">You Forgot <br/> 
   <span class="account">Password</span>
</p>
<p class="signdesc">Please enter your email address so we can send you an email to reset your password.</p>
